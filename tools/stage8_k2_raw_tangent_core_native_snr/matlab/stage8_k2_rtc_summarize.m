...
for k = 1:height(combinations)
    ...
    row.localization_success_count = nnz(t.localization_success_01bw);
    row.resolution_success_count = nnz(t.resolution_success);
    row.rho_lower_bound_hit_count = nnz(t.rho_lower_bound_hit);
