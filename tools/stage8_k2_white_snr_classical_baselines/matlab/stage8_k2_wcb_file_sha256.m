function digest = stage8_k2_wcb_file_sha256(path_now)
%STAGE8_K2_WCB_FILE_SHA256 Hash one file without text normalization.

fid = fopen(path_now, 'rb');
if fid < 0
    error('stage8_k2_wcb_file_sha256:Open', ...
