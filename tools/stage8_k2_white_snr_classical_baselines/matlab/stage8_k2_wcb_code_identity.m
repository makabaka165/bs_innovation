function identity = stage8_k2_wcb_code_identity(repo_dir)
%STAGE8_K2_WCB_CODE_IDENTITY Bind every file in the isolated tool tree.

tool_root = fullfile(repo_dir, 'tools', ...
    'stage8_k2_white_snr_classical_baselines');
