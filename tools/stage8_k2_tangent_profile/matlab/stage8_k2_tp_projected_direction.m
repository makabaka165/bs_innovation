function result = stage8_k2_tp_projected_direction(T_input, Ct_input)
%STAGE8_K2_TP_PROJECTED_DIRECTION Solve the stable 2-D generalized problem.
...
if ~(isnumeric(T_input) && isreal(T_input) && ...
    ...
    error('stage8_k2_tp_projected_direction:Input', ...
...
if any(lambda < -negative_tolerance)
    error('stage8_k2_tp_projected_direction:IndefiniteMetric', ...
