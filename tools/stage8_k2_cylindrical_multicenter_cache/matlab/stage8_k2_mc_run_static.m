...
for noise_index = 1:numel(fixture.noise_profile_ids)
    for center_index = 1:fixture.center_count
        ...
        production_rows{row_index} = struct('center_offset',bundle.center.column_offset, ...
            ...
            'raw_rebuilt_W_error',bundle.debug.independent_W_relative_error, ...
            'raw_rebuilt_C_error',bundle.debug.independent_C_relative_error, ...
            'raw_rebuilt_T_error',bundle.debug.independent_T_basis_relative_error, ...
