function [delta_grid, el_grid] = step11_7_build_cache_union_grid(cfg, policy_cfg, ~, coarse_search_cfg, base_refine_cfg)
...
delta_values = reshape(coarse_centers_delta(:) + coarse_grid_offsets(:).', 1, []);
delta_values = [delta_values, -1.8:base_refine_cfg.fine_az_step:1.8];
