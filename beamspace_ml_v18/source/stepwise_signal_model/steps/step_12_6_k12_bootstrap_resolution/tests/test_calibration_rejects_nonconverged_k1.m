function result = test_calibration_rejects_nonconverged_k1()
%TEST_CALIBRATION_REJECTS_NONCONVERGED_K1 Reject a bootstrap K1 fit.
...
assert(pass, 'test_calibration_rejects_nonconverged_k1:Failed', ...
    'A nonconverged bootstrap K1 fit was accepted.');
