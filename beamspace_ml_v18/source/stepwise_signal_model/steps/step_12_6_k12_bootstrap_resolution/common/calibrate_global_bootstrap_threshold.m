...
noise_profile_count = 1;
if all(isfield(cells, 'noise_profile_id'))
    noise_profile_count = numel(unique(string({cells.noise_profile_id})));
end
...
artifact = struct( ...
    ...
    'cell_count', numel(cells), ...
    'noise_profile_count', noise_profile_count, ...
