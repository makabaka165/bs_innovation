function locked = build_stage5_locked_config()
%BUILD_STAGE5_LOCKED_CONFIG Return the pre-holdout registered configuration.
...
locked.domain_options = struct( ...
    'azimuth_offsets_deg', locked.azimuth_offsets_deg, ...
    'elevation_offsets_deg', locked.elevation_offsets_deg, ...
    'domain_id', 'STAGE5_COMMON_LOCAL_DOMAIN_V1', ...
    'domain_source', ...
    'pre_registered_conventional_center_and_fixed_resolution_offsets', ...
